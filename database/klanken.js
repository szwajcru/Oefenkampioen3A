  ...
  const KLINKER_WOORDEN = {
    ...
    'f': ['fles', 'fiets', 'fijn', 'foto', 'film', 'fout', 'fluit', 'friet', 'af'],
    ...
    'm': ['man', 'mes', 'muis', 'mug', 'molen', 'maan', 'meer', 'mooi', 'mis'],
    ...
    'v': ['vis', 'vuur', 'vork', 'vader', 'vlag', 'vrolijk', 'veel', 'vier', 'voor'],
    'w': ['water', 'wiel', 'wip', 'wolk', 'woord', 'woud', 'wesp', 'wand'],
    'z': ['zak', 'zoon', 'zand', 'zeep', 'zeil', 'zomer', 'zout', 'zon', 'zee'],
